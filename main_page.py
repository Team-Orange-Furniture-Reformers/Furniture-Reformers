...
st.page_link("pages/page1.py", label = ":orange[Click here to find out more]")
...
st.page_link("pages/page2.py", label = ":orange[Click here to find out more]")
...
st.page_link("pages/page3.py", label = ":orange[Click here to find out more]")